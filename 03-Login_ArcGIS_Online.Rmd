...
library(vembedr)
embed_msstream('43d0ddc3-3242-493e-b01f-f34a5c0c8b71') %>% use_align('center')
```
...
library(vembedr)
embed_msstream('9b4b5bf9-75ba-441e-987e-2f93403286f7') %>% use_align('center')
```
...
library(vembedr)
embed_msstream('05ba4760-d042-4e14-a3ed-69973e8ec395') %>% use_align('center')
```
...
library(vembedr)
embed_msstream('75855486-d31b-431e-a5d2-549a86e9a0f8') %>% use_align('center')
```
...
library(vembedr)
embed_msstream('aee33b7f-ed44-4eaa-9b7a-0ea3c947610a') %>% use_align('center')
```
...
library(vembedr)
embed_msstream('aba53b1e-47a5-4dea-b957-c865a350cb21') %>% use_align('center')
```
...
library(vembedr)
embed_msstream('7587496a-5a82-4a24-b8cc-1e3c28994d72') %>% use_align('center')
```
