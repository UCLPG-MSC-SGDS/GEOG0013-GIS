...
|**Group**|**Date**|**Location**|
|:--- |:---------        |:-----------------------   |
|**A**|**Wednesday, 13/11**| Bedford Way (26) Room 316 (Public Cluster), [**Map**](http://www.ucl.ac.uk/maps/26-bedford-way)|
|**B**|**Wednesday, 13/11**| Foster Court, Room B29 (Public Cluster), [**Map**](http://www.ucl.ac.uk/maps/foster-court)|
|**C**|**Wednesday, 13/11**| IOE, Bedford Way (20) Room 790, [**Map**](http://www.ucl.ac.uk/maps/ioe) |
|**D**|**Friday, 15/11**| Chadwick Building, Room 2.23 (Public Cluster) [**Map**](http://www.ucl.ac.uk/maps/chadwick-building)|
|**E**|**Friday, 15/11**| IOE, Bedford Way (20) Room 425 (PC Lab 2), [**Map**](http://www.ucl.ac.uk/maps/ioe)|
|**F**|**Friday, 15/11**| Foster Court, Room 233, [**Map**](http://www.ucl.ac.uk/maps/foster-court)|
|**G**|**Friday, 15/11**| UCL GOSICH - Wolfson Centre Room D (Ground Floor), [**Map**](http://www.ucl.ac.uk/maps/ich-wolfson-centre)|

<div class="note">
**IMPORTANT NOTE**: The locations for groups **A, B, D, E, G** are public clusters with PC workstations. For groups **C and F**, please bring your own laptop for the computer practicals as these are standalone rooms.  
</div>
...
<div class="note">
**IMPORTANT NOTE**: You must create a StoryMap with the lore elements of your theme and the interactive map embedded to it, which must be submitted as a link using the submission sheet. This assignment is worth 10.0% of the assessment, and the deadline is on **Friday, 6th December before 12:00pm** 
</div>
